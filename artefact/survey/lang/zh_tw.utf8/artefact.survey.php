...
$string['pluginname'] = '問卷'; // For tabs and menus...
...
$string['selectsurvey'] = '選擇問卷...';
$string['categorylanguage'] = '語言問卷';
$string['categorypersonal'] = '人格問卷';
$string['categorycareer'] = '職業問卷';
$string['categoryother'] = '其他問卷';
$string['categorystaff'] = 'Staff surveys';

$string['recipients'] = '收件人';
$string['allusers'] = '全部名單';
$string['surveyrecipients'] = '問卷結果收件人';
...
$string['surveysettings'] = '問卷設定';
$string['surveytitle'] = '問卷標題';
...
$string['surveycreated'] = '建立時間';
$string['surveymodified'] = '最後修改';
...
$string['language.zh_TW'] = '中文 – (zh_TW)'; 	// Bulgarian
