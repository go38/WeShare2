...
/**
 * Renders survey form (RTL language direction) elements inside a <table>.
 ...
 */
function pieform_renderer_survey_rtl(Pieform $form, $element) {/*{{{*/
...
function pieform_renderer_survey_rtl_header() {/*{{{*/
    return "<table cellspacing=\"0\"><tbody>\n";
}/*}}}*/

function pieform_renderer_survey_rtl_footer() {/*{{{*/
    return "</tbody></table>\n";
}/*}}}*/
