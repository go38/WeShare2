...
function admin_nav() {
    $menu = array(
        ...
        'adminlang/translate' => array(
            'path'   => 'adminlang/translate',
            'url'    => 'admin/lang.php',
            'title'  => get_string('languagetranslation', 'admin'),
            'weight' => 10,
        ),
        'adminlang/translatehelp' => array(
            'path'   => 'adminlang/translatehelp',
            'url'    => 'admin/langhelp.php',
            'title'  => get_string('helpfilestranslation', 'admin'),
            'weight' => 20,
        ),
        'adminlang/reports' => array(
            'path'   => 'adminlang/reports',
            'url'    => 'admin/langreport.php',
            'title'  => get_string('langreports', 'admin'),
            'weight' => 30,
        ),
